...
class IKResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.solutions[i] = moveit_msgs.msg.RobotState.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.solutions !== undefined) {
      ...
      for (let i = 0; i < resolved.solutions.length; ++i) {
        resolved.solutions[i] = moveit_msgs.msg.RobotState.Resolve(msg.solutions[i]);
      }
    }
    else {
      resolved.solutions = []
