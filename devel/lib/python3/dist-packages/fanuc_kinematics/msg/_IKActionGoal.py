...
"""autogenerated by genpy from fanuc_kinematics/IKActionGoal.msg. Do not edit."""
import codecs
import sys
...
class IKActionGoal(genpy.Message):
  ...
  _type = "fanuc_kinematics/IKActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','fanuc_kinematics/IKGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = fanuc_kinematics.msg.IKGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = fanuc_kinematics.msg.IKGoal()
