...
"""autogenerated by genpy from fanuc_kinematics/IKActionResult.msg. Do not edit."""
import codecs
import sys
...
class IKActionResult(genpy.Message):
  _md5sum = "57395de46e75bfad748516edb76fda75"
  _type = "fanuc_kinematics/IKActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fanuc_kinematics/IKResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = fanuc_kinematics.msg.IKResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fanuc_kinematics.msg.IKResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.solutions)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.solutions:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.solutions.append(val1)
      return self
